...
*/
typedef int COMP(void* x, void* y);//ponteiro de função que retorna int, com definição no escopo da função
//int (*COMP)(void * x,void * y) mesma coisa
...
typedef struct vet{
	...
	void** elems;//o vetor de elementos //vetor de ponteiros genericos
